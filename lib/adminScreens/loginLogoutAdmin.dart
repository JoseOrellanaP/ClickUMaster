...
class clickULoginLogOutAdmin extends StatefulWidget {
  @override
  _clickULoginLogOutAdminState createState() => _clickULoginLogOutAdminState();
}

class _clickULoginLogOutAdminState extends State<clickULoginLogOutAdmin> {
